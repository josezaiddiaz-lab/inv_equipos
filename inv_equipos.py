...
if modo_orden_servicio:
  ...
  if df_os_filtrado.empty:
    ...
    def generar_orden_servicio_multiple_pdf(seleccion_df):
      ...
      # Estilos ajustados con mejor interlineado (leading) para evitar empalmes
      ...
      # Estructura corregida: La fecha va en la celda contigua (a lo largo) en lugar de estar amontonada
      header_data = [
          [
              Paragraph("<i>Calidad y Servicio</i><br/><font size=18 color='#1f3a93'><b>GCM</b></font><br/><b>compumercado</b><br/><br/><b>VENTA DE EQUIPO DE COMPUTO</b><br/>Divisoria 506, Col. Fracc. San Angel, CD Altamira,<br/>Tamaulipas, CP 89604", style_normal),
              Table([
                  ...
                  [Paragraph("<b>Telefonos</b>", style_bold), Paragraph("(833)125-2045", style_normal)],
