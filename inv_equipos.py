...
if modo_orden_servicio:
  ...
  if df_os_filtrado.empty:
    ...
    def generar_orden_servicio_multiple_pdf(seleccion_df):
      ...
      # Estilos con interlineado (leading) corregido para evitar solapamientos
      ...
      # Estructura del logo ajustada para que "Calidad y Servicio", "GCM" y "compumercado" tengan espacio vertical correcto
      logo_text = (
          "<i><font size=9>Calidad y Servicio</font></i><br/>"
          "<font size=24 color='#1f3a93'><b>GCM</b></font><br/>"
          "<font size=12 color='#000000'><b>compumercado</b></font><br/><br/>"
          "<b>VENTA DE EQUIPO DE COMPUTO</b><br/>"
          "Divisoria 506, Col. Fracc. San Angel, CD Altamira,<br/>"
          "Tamaulipas, CP 89604"
      )

      header_data = [
          [
              Paragraph(logo_text, style_normal),
              Table([
