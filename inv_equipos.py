...
# Conexión a Google Sheets mediante el conector oficial de Streamlit
conn = st.connection("gsheets", type=GSheetsConnection)

def cargar_datos():
  try:
    # Lee directamente la pestaña "Mantenimientos"
...
def guardar_datos_en_gsheets(df):
  try:
    # Actualiza la hoja "Mantenimientos" con el DataFrame completo
    conn.update(worksheet="Mantenimientos", data=df)
    st.cache_data.clear()
  except Exception as e:
