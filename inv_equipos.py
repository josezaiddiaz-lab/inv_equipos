...
if modo_orden_servicio:
  ...
  if df_os_filtrado.empty:
    ...
    def generar_orden_servicio_multiple_pdf(seleccion_df):
      ...
      # Estilos específicos para el logotipo con mayor separación vertical
      style_logo_top = ParagraphStyle('LogoTop', parent=styles['Normal'], fontSize=10, fontName='Helvetica-Oblique', textColor=colors.black, spaceAfter=4)
      style_logo_main = ParagraphStyle('LogoMain', parent=styles['Normal'], fontSize=22, fontName='Helvetica-Bold', textColor=colors.HexColor('#1f3a93'), spaceAfter=8)
      style_logo_sub = ParagraphStyle('LogoSub', parent=styles['Normal'], fontSize=12, fontName='Helvetica-Bold', textColor=colors.black, spaceAfter=14)
      ...
      # Tabla interna para separar cada línea del logotipo con espacios verticales controlados
