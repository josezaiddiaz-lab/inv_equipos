...
if modo_orden_servicio:
  ...
  # Filtros de búsqueda para la orden de servicio
  ...
  if df_os_filtrado.empty:
    ...
    # Mostrar tabla filtrada para referencia visual
    ...
    # Crear lista de opciones amigables para selección múltiple
    opciones_equipos = [
    ...
    # Filtrar las filas seleccionadas reales
    ...
    def generar_orden_servicio_multiple_pdf(seleccion_df):
      ...
      header_data = [
          [
              ...
              Paragraph("<b>ORDEN DE SERVICIO</b><br/><br/><b>Fecha:</b> " + str(fecha_ingreso_val), style_normal),
