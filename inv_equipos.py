...
if modo_orden_servicio:
  ...
  if df_os_filtrado.empty:
    ...
    def generar_orden_servicio_multiple_pdf(seleccion_df):
      ...
      # Estructura idéntica a la imagen provista para la cabecera
      header_data = [
          [
              ...
              Table([
                  [Paragraph("<b>ORDEN DE SERVICIO</b>", style_center)],
                  [Paragraph(f"<b>Fecha:</b> {fecha_ingreso_val}", style_normal)],
