...
st.subheader("📊 Tabla de Inventario (Editable y Sincronizada)")
st.info(
    "💡 Puedes hacer clic en cualquier celda para editarla, o eliminar filas directamente."
)
...
# Sincronización automática con el archivo CSV
...
# --- SECCIÓN PARA EDITAR O ELIMINAR REGISTROS (EXPANDER INFERIOR) ---
