...
SPREADSHEET_URL = "https://docs.google.com/spreadsheets/d/1SLqZPvhB38nsBkSH3bARtKdzKzdgpwZlfPfxUcTJo10/edit?gid=0#gid=0"
...
# Usamos caché con ttl=60 para evitar sobrepasar el límite de peticiones por minuto de Google
...
if df_filtrado.empty:
  ...
  # Usamos st.dataframe en lugar de st.data_editor para evitar bloqueos y bucles de carga
  ...
  if not df.empty:
    ...
    with st.form("form_editar"):
      ...
      if actualizar:
        ...
        guardar_dates = guardar_datos_en_gsheets(df)
