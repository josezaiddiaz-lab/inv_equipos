...
if modo_orden_servicio:
  ...
  if df_os_filtrado.empty:
    ...
    st.dataframe(df_mostrar_os, use_container_width=True, hide_index=True)
    ...
    def generar_orden_servicio_multiple_pdf(seleccion_df):
      ...
      # Cambiado "TOTAL" por "DEPARTAMENTO" en la cabecera de la tabla
      table_content = [
      ...
      if seleccion_df.empty:
        ...
        for _, row_data in seleccion_df.iterrows():
          ...
          # Obtenemos el departamento del registro actual
