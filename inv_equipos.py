...
SPREADSHEET_URL = "https://docs.google.com/spreadsheets/d/1JvQ27EDdRINstMHPCJP40NbLt7vl3qir/edit"
...
def conectar_gsheets():
  ...
  if "gcp_service_account" in st.secrets:
    ...
    if "private_key" in creds_dict:
      # Limpiar y asegurar formato correcto de la llave privada
      pk = creds_dict["private_key"].strip()
      pk = pk.replace("\\n", "\n")
      # Asegurar cabeceras y pies correctos si se corrompieron
