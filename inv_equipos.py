...
SPREADSHEET_URL = "https://docs.google.com/spreadsheets/d/1JvQ27EDdRlNstMHPCjP40NbLt7vI3qir/edit?pli=1&gid=1550104193#gid=1550104193"
...
if not df_filtrado.empty:
  ...
  st.download_button(
      ...
      data=pdf_data,
      file_name=f"inventario_estado_{filtro_estado.lower()}.pdf",  # <-- Corregido aquí
