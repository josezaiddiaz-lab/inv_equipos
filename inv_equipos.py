...
if modo_orden_servicio:
  ...
  if df_os_filtrado.empty:
    ...
    def generar_orden_servicio_multiple_pdf(seleccion_df):
      ...
      # Configuración de la imagen real del logotipo
      logo_imagen = Image("logo.png", width=150, height=48)
      ...
      # Estructura de la tabla del logotipo combinando la imagen y su dirección abajo
