...
# Sincronización automática de cambios de la tabla interactiva con el archivo CSV
if not df_editado.equals(df_mostrar):
  # Quitamos la columna 'N°' temporal antes de guardar los datos en el CSV
  ...
  if filtro_cliente or filtro_estado != "Todos" or filtro_serie:
    ...
    df = df_limpio
  df.to_csv(DATA_FILE, index=False)
  st.success("¡Cambios guardados en el archivo Excel/CSV!")
  st.rerun()
